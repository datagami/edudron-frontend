    ...
    return (
        ...
        <Formik
            ...
            validate={(values) => {
                console.log(values)
                const errors = {};
                if (!values.select_course) errors.select_course = "Course is required";
                    ...
                    <Form className={"details__wrapper"}>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className={`form__item ${errors.select_course && "input__error"}`}>
                                    <Form.Label htmlFor="estd_date">Course</Form.Label>
                                    <Form.Select id="estd_date" name={"select_course"} className="Multi_step_form_input select_dropdown">
                                    ...
                                    <p className={"error__feedback"}>{errors.select_course}</p>
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className={`form__item ${errors.fees && "input__error"}`}>
                                    <label>Fees</label>
                                    <Input name={"fees"} className="Multi_step_form_input" />
                                    <p className={"error__feedback"}>{errors.fees}</p>
                                </div>
                            </div>
